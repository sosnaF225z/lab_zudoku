import{u as s,j as e}from"./entry.client-WiYs6lwO.js";const a="The Task Management API uses API Keys or Bearer Tokens to ensure that only authorized users can access project data.",o=[{depth:2,text:"🔑 Authorization",id:"-authorization",children:[{depth:3,text:"1. Obtaining your Credentials",id:"1-obtaining-your-credentials"},{depth:3,text:"2. Configuring the Client",id:"2-configuring-the-client"}]}],c={lastModifiedTime:"2026-04-01T16:03:32.000Z"},l="pages/Authorization.mdx";function i(t){const n={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",span:"span",strong:"strong",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"-authorization",children:"🔑 Authorization"}),`
...
//# sourceMappingURL=Authorization-mbJRPBEX.js.map
